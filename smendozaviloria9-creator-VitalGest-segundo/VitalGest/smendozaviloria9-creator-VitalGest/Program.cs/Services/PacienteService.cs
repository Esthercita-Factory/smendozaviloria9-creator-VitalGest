...
namespace VitalGest.Services
{
    public class PacienteService
    {
        ...
        // TASK 3: registra un Paciente y, opcionalmente, sus mascotas asociadas (List<Mascota>).
        ...
        // TASK 3: recorre y muestra en pantalla todas las mascotas de un paciente.
        ...
        // TASK 5: busca una mascota por nombre exacto entre todos los pacientes.
        // En vez de devolver null cuando no la encuentra, lanza una excepcion
        // propia (MascotaNoEncontradaException) para que quien llama el metodo
        // se entere del error real y no siga trabajando con un valor vacio.
